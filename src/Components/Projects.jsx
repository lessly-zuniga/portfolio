...
<div className='blockCard' >
            <div className='card' >
                ...
                <div className='card-text'>
                    ...
                    <h5>Plans</h5>
                    <p> Que no se te vayan las ideas!
                        <br></br>
                ...
                <div className='card'>
                    ...
                    <div className='card-text'>
                        <h5>Gigil </h5>
                        <p>Las mejores peliculas y series de amor a un click!
                        </p>
                ...
                <div className='card'>
                    ...
                    <div className='card-text'>
                        <h5>Md-links</h5>
                        <p>Encuentra todos los enlaces que necesitas en un texto super rapido! </p>
